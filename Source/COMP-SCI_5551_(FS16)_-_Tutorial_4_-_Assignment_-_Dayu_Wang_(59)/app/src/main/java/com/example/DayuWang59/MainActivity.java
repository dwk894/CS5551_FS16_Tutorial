...
public class MainActivity extends Activity {
	...
	public class GetLargePhotoThread extends Thread {
		...
		GetLargePhotoThread(ImageContener ic, UIHandler uih) {
			this.ic = ic;
			this.uih = uih;
		}
	...
	public class ImageAdapter extends BaseAdapter {
		...
		ArrayList<ImageContener> getImageContener() {
		...
		ImageAdapter(Context c, ArrayList<ImageContener> imageContener) {
			mContext = c;
			this.imageContener = imageContener;
